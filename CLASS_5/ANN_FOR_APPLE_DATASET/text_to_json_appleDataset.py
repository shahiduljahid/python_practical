...
def yolo_txt_to_json(txt_file, output_dir):
    """
...
def convert_yolo_txt_to_json(txt_dir, output_dir):
    """
...
convert_yolo_txt_to_json(txtTrainFolder, txtToJSONTrainFolder)
convert_yolo_txt_to_json(txtTestFolder, txtToJSONTestFolder)